...
library(tidyverse)
mecha_mpg <- read.csv(file='~/Class/MechaCarChallenge/MechaCar_mpg.csv',check.names=F,stringsAsFactors = F) 
...
mecha_coil <- read.csv(file='~/Class/MechaCarChallenge/Suspension_Coil.csv',check.names=F,stringsAsFactors = F) 
